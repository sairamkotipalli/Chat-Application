    ...
    return (
        <>
                    ...
                    <Menu>
                        ...
                        <MenuList>
                            <ProfileModal user={user}>
                                <MenuItem _hover={{ bg: '#D6E2F1' }} color='blue.600'>My Profile</MenuItem>
                            </ProfileModal>
                            <MenuDivider />
                            <MenuItem onClick={logoutHandler} _hover={{ bg: '#F1D6D6' }} color='red.500'>Logout</MenuItem>
                        </MenuList>
                    </Menu>
                </div>
            </Box>
            ...
            <Drawer
                ...
                onClose={onClose}
            >
                <DrawerOverlay bg='rgba(1,1,1,0.8)' />
                <DrawerContent>
                    ...
                    <DrawerBody>
                        <Box display='flex' pb={2}>
                            ...
                            />
                            {<Button onClick={handleSearch} bg='#bfdbf7'>Go</Button>}
                        </Box>
